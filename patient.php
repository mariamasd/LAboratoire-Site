...
<body>
   ...
   <div class="card">
        <div class="card-header">
            <h3 class="text-center">Ajout d'un nouveau Patient</h3>
        </div>
        <div class="card-body">
        <div class="container">
        <form class="form" action="secretaire.php" method="POST" >
        <label for="">SEXE:</label>
        <div class="form-check">
        <label for="sx">feminin </label>
            <input  class="form-check-label" type="radio" name="sexepatient" id="sx" value="feminin">
            <label for="sx">masculin </label>
            <input class="form-check-label" type="radio" name="sexepatient" id="sx" value="masculin">
        </div>
            <label for="nom">Nom_Patient </label>
            <input class="form-control" type="text" name="nompatient" id="nom">
            <label for="pr">Prenom_Patient </label>
            <input class="form-control" type="text" name="prenompatient" id="pr">
            <label for="date">DateNaiss_Patient</label>
            <input class="form-control" type="date" name="datenaisspatient" id="date">
            <label for="ad">Adresse_Patient </label>
            <input class="form-control" type="text" name="adressepatient" id="ad">
            <label for="tel">Tel_Patient </label>
            <input class="form-control" type="tel" name="telpatient" id="tel">
            <label for="email"> Email_Patient</label>
            <input class="form-control" type="email" name="emailpatient" id="email">
            <label for="dateen"> DateEnregistrement_Patient</label>
            <input class="form-control" type="date" name="dateenr" id="date">
            <label for="daterv">DateRV_Patient</label>
            <input class="form-control" type="date" name="daterv" id="daterv">
            <label for="nat">Nationalites</label>
            <select class="form-control" name="nationalitepatient"id="nat">
    ...
    <input class="btn btn-primary mt-5" type="submit" value="VALIDEZ">
    </form>
    </div>
        </div>
    </div>
